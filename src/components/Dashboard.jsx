...
export default function Dashboard() {
  ...
  const stats = useMemo(() => {
    ...
    return { total, solved, easy, solvedEasy, medium, solvedMedium, hard, solvedHard, importantCount };
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "24px", marginBottom: "32px" }}>
        ...
        <AnimatedCard delay={0.2} className="card-hover-lift" style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div>
            <p className="text-muted" style={{ fontSize: "13px", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "4px" }}>Important</p>
            <h3 style={{ fontSize: "28px", fontWeight: "800", lineHeight: "1" }}>
        ...
        <AnimatedCard delay={0.3} className="card-hover-lift" style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div>
            <p className="text-muted" style={{ fontSize: "13px", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "4px" }}>Mastery Level</p>
            <h3 style={{ fontSize: "28px", fontWeight: "800", lineHeight: "1" }}>
              {((stats.solved / Math.max(stats.total, 1)) * 100).toFixed(1)}%
            </h3>
          </div>
        </AnimatedCard>
      </div>
